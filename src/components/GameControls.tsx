        ...
        <ModalContent>
          ...
          <ModalBody>
            <FormControl>
              <Stack spacing={12}>
                <Stack spacing={4}>
                  <Heading as='h5' size='sm' fontWeight='medium'>Player 1</Heading>
                  <InputGroup>
                    <InputLeftElement pointerEvents='none' children={<FiUsersIcon />} />
                  ...
                  <RadioGroup onChange={setCustomColorPlayer1} value={customColorPlayer1} defaultValue={customColorPlayer1}>
                    <Stack direction='row'>
                      {Object.entries(colors).map((color, index) => {
                        ...
                        return <Radio key={index} value={color[1]} colorScheme={color[0]}>{colorFormatted}</Radio>;
                        }
                      )}
                    </Stack>
                  </RadioGroup>
                ...
                <Stack spacing={4}>
                  <Heading as='h5' size='sm' fontWeight='medium'>Player 2</Heading>
                  <InputGroup>
                    <InputLeftElement pointerEvents='none' children={<FiUsersIcon />}/>
